...
class AppController {
  ...
  static getStats(request, response) {
    const getUsers = () => new Promise(resolve => setTimeout(() => resolve(dbClient.nbUsers()), 1000));
    const getFiles = () => new Promise(resolve => setTimeout(() => resolve(dbClient.nbFiles()), 1000));
